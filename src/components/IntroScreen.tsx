...
export const IntroScreen: React.FC<IntroScreenProps> = ({ onStart, onToggleSidebar, userProfiles }) => {
  ...
  const AVATAR_OPTIONS = [
    "https://lh3.googleusercontent.com/u/0/d/1QwnYX60AUbQqm9cSbTuaZzP2W6CXcyD1"
  ];
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onStart({
      name: name.trim(),
      appearance: appearance.trim() || "Mong manh, đỏng đảnh và xinh đẹp thanh tao. Nước da trắng nhớt như ngó sen, dáng vẻ liễu rủ khêu gợi.",
      personality: personality.trim(),
      age: 18,
      background: "Là em gái út của Cai Tuần. Đương mang gánh nặng nợ nần cho gia cang và có mối tình thề độc trăm đồng bạc với Thuận."
    }, selectedAvatar);
  };
